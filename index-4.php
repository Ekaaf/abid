    ...
    <div class="page-wrapper">
        ...
        <section class="hero hero-slider-wrapper">
            <div class="hero-slider hero-slider-style-1">
                ...
                ?>
                <div class="slide">
                    <img src="slider/<?php echo $i; ?>.jpg" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
                ...
                <div class="row">
                    <div class="col col-md-7">
                        <div class="project-single-img">
                            <img src="assets/images/project-single-img.jpg" alt>
                        </div>
                    </div>
        ...
        <section class="contact-section section-padding parallax" data-bg-image="assets/images/contact-section-bg.html">
            <div class="container">
                <div class="row">
